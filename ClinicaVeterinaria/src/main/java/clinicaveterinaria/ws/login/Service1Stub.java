...
public class Service1Stub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://tempuri.org/", "validarUsuario"));
		_service.addOperation(__operation);
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback.receiveResulthelloWorld((clinicaveterinaria.ws.login.Service1Stub.HelloWorldResponse) object);
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions()
					.getSoapVersionURI()), validarUsuario2,
					optimizeContent(new javax.xml.namespace.QName(
							"http://tempuri.org/", "validarUsuario")),
					new javax.xml.namespace.QName("http://tempuri.org/",
							"validarUsuario"));
			...
			if (faultElt != null) {
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(
								faultElt.getQName(), "ValidarUsuario"))) {
					// make the fault by reflection
					try {
						java.lang.String exceptionClassName = (java.lang.String) faultExceptionClassNameMap
								.get(new org.apache.axis2.client.FaultMapKey(
					...
					public void onMessage(
						...
						try {
							...
							java.lang.Object object = fromOM(
									...
									clinicaveterinaria.ws.login.Service1Stub.ValidarUsuarioResponse.class,
									getEnvelopeNamespaces(resultEnv));
							callback.receiveResultvalidarUsuario((clinicaveterinaria.ws.login.Service1Stub.ValidarUsuarioResponse) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap
									...
									try {
										...
										callback.receiveErrorvalidarUsuario(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
										// we cannot intantiate the class -
										// throw the original Axis fault
	...
	public static class ValidarUsuario implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://tempuri.org/", "ValidarUsuario", "ns1");
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							...
							"type", namespacePrefix + ":ValidarUsuario",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "ValidarUsuario", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 */
			public static ValidarUsuario parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				ValidarUsuario object = new ValidarUsuario();
				...
				try {
							...
							if (!"ValidarUsuario".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ValidarUsuario) ExtensionMapper
					...
					if (reader.isStartElement()
						...
						object.setUsuario(org.apache.axis2.databinding.utils.ConverterUtil
	...
	public static class HelloWorldResponse implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://tempuri.org/", "HelloWorldResponse", "ns1");
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (localHelloWorldResultTracker) {
				namespace = "http://tempuri.org/";
				writeStartElement(null, namespace, "HelloWorldResult",
						xmlWriter);
	...
	public static class ValidarUsuarioResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://tempuri.org/", "ValidarUsuarioResponse", "ns1");
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "ValidarUsuarioResponse", xmlWriter);
				}
			...
			if (localValidarUsuarioResultTracker) {
				if (localValidarUsuarioResult == null) {
					throw new org.apache.axis2.databinding.ADBException(
							"ValidarUsuarioResult cannot be null!!");
				}
				localValidarUsuarioResult.serialize(
						new javax.xml.namespace.QName("http://tempuri.org/",
								"ValidarUsuarioResult"), xmlWriter);
			}
			xmlWriter.writeEndElement();
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (localValidarUsuarioResultTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://tempuri.org/", "ValidarUsuarioResult"));
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static ValidarUsuarioResponse parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				...
				try {
						...
						if (fullTypeName != null) {
							...
							if (!"ValidarUsuarioResponse".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ValidarUsuarioResponse) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement()
							&& new javax.xml.namespace.QName(
									"http://tempuri.org/",
									"ValidarUsuarioResult").equals(reader
									.getName())) {

						object.setValidarUsuarioResult(ClsBE_Usuario.Factory
								.parse(reader));
	...
	public static class HelloWorld implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://tempuri.org/", "HelloWorld", "ns1");
	...
	public static class ClsBE_Usuario implements
			org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name =
		 * clsBE_Usuario Namespace URI = http://tempuri.org/ Namespace Prefix =
		 * ns1
		 */
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":clsBE_Usuario",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "clsBE_Usuario", xmlWriter);
				}
			...
			if (false) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"Exito cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localExito));
			}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (localApellidoTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://tempuri.org/", "Apellido"));

				if (localApellido != null) {
					elementList
							.add(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(localApellido));
				} else {
					throw new org.apache.axis2.databinding.ADBException(
							"Apellido cannot be null!!");
				}
			...
			if (localTelefonoTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://tempuri.org/", "Telefono"));

				if (localTelefono != null) {
					elementList
							.add(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(localTelefono));
				} else {
					throw new org.apache.axis2.databinding.ADBException(
							"Telefono cannot be null!!");
				}
			...
			if (localPerfilTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://tempuri.org/", "Perfil"));

				if (localPerfil != null) {
					elementList
							.add(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(localPerfil));
				} else {
					throw new org.apache.axis2.databinding.ADBException(
							"Perfil cannot be null!!");
				}
			...
			if (localMensajeTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://tempuri.org/", "Mensaje"));

				if (localMensaje != null) {
					elementList
							.add(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(localMensaje));
				} else {
					throw new org.apache.axis2.databinding.ADBException(
							"Mensaje cannot be null!!");
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static ClsBE_Usuario parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				ClsBE_Usuario object = new ClsBE_Usuario();
				...
				try {
						...
						if (fullTypeName != null) {
							...
							if (!"clsBE_Usuario".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ClsBE_Usuario) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement()
						...
						object.setClave(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if ("true".equals(nillableValue)
								|| "1".equals(nillableValue)) {
							throw new org.apache.axis2.databinding.ADBException(
									"The element: " + "Apellido"
											+ "  cannot be null");
						}

						java.lang.String content = reader.getElementText();

						object.setApellido(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
					...
					if (reader.isStartElement()
						...
						if ("true".equals(nillableValue)
								|| "1".equals(nillableValue)) {
							throw new org.apache.axis2.databinding.ADBException(
									"The element: " + "Telefono"
											+ "  cannot be null");
						}

						java.lang.String content = reader.getElementText();

						object.setTelefono(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
					...
					if (reader.isStartElement()
						...
						object.setPerfil(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
					...
					if (reader.isStartElement()
						...
						object.setMensaje(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
					...
					if (reader.isStartElement()
						...
						object.setExito(org.apache.axis2.databinding.utils.ConverterUtil
	...
	private org.apache.axiom.om.OMElement toOM(
			clinicaveterinaria.ws.login.Service1Stub.HelloWorld param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							clinicaveterinaria.ws.login.Service1Stub.HelloWorld.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			clinicaveterinaria.ws.login.Service1Stub.HelloWorldResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							clinicaveterinaria.ws.login.Service1Stub.HelloWorldResponse.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			clinicaveterinaria.ws.login.Service1Stub.ValidarUsuario param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							clinicaveterinaria.ws.login.Service1Stub.ValidarUsuario.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			clinicaveterinaria.ws.login.Service1Stub.ValidarUsuarioResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							clinicaveterinaria.ws.login.Service1Stub.ValidarUsuarioResponse.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (clinicaveterinaria.ws.login.Service1Stub.HelloWorld.class
					.equals(type)) {

				return clinicaveterinaria.ws.login.Service1Stub.HelloWorld.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (clinicaveterinaria.ws.login.Service1Stub.HelloWorldResponse.class
					.equals(type)) {

				return clinicaveterinaria.ws.login.Service1Stub.HelloWorldResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (clinicaveterinaria.ws.login.Service1Stub.ValidarUsuario.class
					.equals(type)) {

				return clinicaveterinaria.ws.login.Service1Stub.ValidarUsuario.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (clinicaveterinaria.ws.login.Service1Stub.ValidarUsuarioResponse.class
					.equals(type)) {

				return clinicaveterinaria.ws.login.Service1Stub.ValidarUsuarioResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
